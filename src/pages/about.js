...
function About(){
    return(
        <>
             <Helmet>
                <title>Website designing in Canada | Logo Design | Digital Marketing in Vancouver - Ehues web solutions</title>
                <meta name="description" content="Ehues web solutions is a rapidly expanding web design company that provides cost-effective web design services, banner design, visiting card design, graphic design, and digital marketing in Vancouver, Canada. Contact us today to obtain top-notch web design services in Vancouver." />
            </Helmet>
